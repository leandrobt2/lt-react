...
class FaqComponent extends React.Component {
                    ...
                    <div className="row">
                        ...
                        <div className="collapse-right col-sm-12 col-md-offset-1 col-md-7 col-lg-offset-1 col-lg-7">
                            ...
                            <div className="panel-group" id="accordion">
                                {
                                    this.state.map(faq => { return this.renderQuestion(faq.id, faq.question, faq.answer); })
                                }
                            </div>
                        </div>
                    </div>
    ...
    renderQuestion(panelId, question, anwser) {
        ...
        return (
            <div className="panel panel-default wow fadeInUp animated" data-wow-offset="10" data-wow-duration="1.5s" id={panelElementId}>
